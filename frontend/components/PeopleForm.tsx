...
export default function People() {
    ...
    // Replace any-typed error usage with a safe formatter
    const errorMessage = useMemo(() => {
        const e = (readError ?? writeError) as unknown;
        if (!e) return undefined;
        if (typeof e === 'object' && e !== null) {
            const withShort = e as { shortMessage?: string };
            const withMessage = e as { message?: string };
            return withShort.shortMessage || withMessage.message || 'Transaction failed';
        }
        return String(e);
